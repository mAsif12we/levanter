...
module.exports = {
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '❤️,Faisal',
  ...
  MENTION: process.env.MENTION || 'Faisal udas',
  ...
  KOYEB_NAME: (process.env.KOYEB_NAME || 'Faisal').trim(),
  ...
  LIST_TYPE: (process.env.LIST_TYPE || 'love').trim(),
